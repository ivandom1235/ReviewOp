...
class BuilderConfig:
    ...
    debug_benchmark_max_rows: int = 10000
    ...
    train_review_filter_mode: str = "salvage_non_general"
    train_salvage_mode: str = "recover_non_general"
    train_salvage_confidence_threshold: float = 0.5
    train_salvage_accepted_support_types: tuple[str, ...] = ("exact", "near_exact", "gold", "symptom_based", "paraphrastic", "domain_consistent_weak")
    ...
    train_topup_confidence_threshold: float = 0.54
    train_topup_staged_recovery: bool = True
    train_topup_stage_b_confidence_threshold: float = 0.5
    train_topup_allow_weak_support_in_stage_c: bool = True
    train_topup_stage_c_confidence_threshold: float = 0.48
    train_topup_allowed_support_types: tuple[str, ...] = ("exact", "near_exact", "gold", "symptom_based", "paraphrastic", "domain_consistent_weak")
